export default class Card {
    ...
    generateCard() {
        ...
        const _image = this._item.querySelector(".element__image");
        _image.src = this._link;
        _image.alt = this._name;
        this._item.querySelector(".element__text").textContent = this._name;
        this._item.querySelector(".element__heart").src = this._like;
        this._likeCounter = this._item.querySelector(".element__heart-box");
        this._likeCounter.textContent = this._likes.length;
        this._item.querySelector(".element__delete-icon").src = this._trash;
        if (this._userId !== this._owner) {
            this._item.querySelector(".element__delete-icon").classList.add("element__delete-icon-invisible");
        }
    ...
    _setEventListeners() {
        this._like = this._item.querySelector(".element__heart")
        this._trash = this._item.querySelector(".element__delete-icon")
    ...
    _getLikeState() {
        return this._like.classList.contains('element__heart_active')
    }
